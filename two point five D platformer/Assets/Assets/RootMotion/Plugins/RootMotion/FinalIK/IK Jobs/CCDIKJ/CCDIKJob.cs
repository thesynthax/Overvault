...
namespace RootMotion.FinalIK
{
    ...
    public struct CCDIKJob : UnityEngine.Animations.IAnimationJob
    {
        ...
        public void Setup(Animator animator, Transform[] bones, Transform target)
        {
            ...
            _IKPositionWeight = UnityEngine.Animations.AnimatorJobExtensions.BindSceneProperty(animator, animator.transform, typeof(CCDIKJ), "weight");
            _maxIterations = UnityEngine.Animations.AnimatorJobExtensions.BindSceneProperty(animator, animator.transform, typeof(CCDIKJ), "maxIterations");
            _tolerance = UnityEngine.Animations.AnimatorJobExtensions.BindSceneProperty(animator, animator.transform, typeof(CCDIKJ), "tolerance");
            _XY = UnityEngine.Animations.AnimatorJobExtensions.BindSceneProperty(animator, animator.transform, typeof(CCDIKJ), "XY");
            _useRotationLimits = UnityEngine.Animations.AnimatorJobExtensions.BindSceneProperty(animator, animator.transform, typeof(CCDIKJ), "useRotationLimits");
        }
