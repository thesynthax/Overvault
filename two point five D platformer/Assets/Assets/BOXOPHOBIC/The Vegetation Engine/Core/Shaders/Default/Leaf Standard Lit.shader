	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 Vertex_Motion_Object833_g55655 = ( ( ( VertexPosRotationAxis50_g62600 + ( VertexPosOtherAxis82_g62600 * cos( Angle44_g62600 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g62600 ) * sin( Angle44_g62600 ) ) ) + Motion_20_Vertical4280_g55655 + Motion_20_Squash4418_g55655 ) + Motion_30_Details263_g55655 );
				...
				float3 Vertex_Motion_World1118_g55655 = ( ( ( temp_output_3474_0_g55655 + appendResult2043_g55655 ) + appendResult2047_g55655 + Motion_20_Vertical4280_g55655 + Motion_20_Squash4418_g55655 ) + Motion_30_Details263_g55655 );
				#ifdef TVE_VERTEX_DATA_BATCHED
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float dotResult777_g55655 = dot( MainLight_Direction3926_g55655 , Main_Normal_WS4101_g55655 );
				float lerpResult4198_g55655 = lerp( 1.0 , saturate( dotResult777_g55655 ) , _MainLightNormalValue);
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1604_g55655 = 0.0;
				#else
				float staticSwitch1604_g55655 = lerpResult4198_g55655;
				#endif
				half Mask_Subsurface_Normal870_g55655 = staticSwitch1604_g55655;
				half3 Subsurface_Scattering1693_g55655 = ( Subsurface_Transmission884_g55655 * Blend_AlbedoColored863_g55655 * ( Mask_Subsurface_View782_g55655 * Mask_Subsurface_Normal870_g55655 ) );
				...
				half Overlay_Mask269_g55655 = saturate( ( ( ( ( ( lerpResult3567_g55655 * 0.5 ) + Main_AlbedoTex_G3526_g55655 ) * Overlay_Commons1365_g55655 ) - temp_output_7_0_g62666 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62666 ) ) );
				...
				float3 lerpResult2945_g55655 = lerp( (_VertexOcclusionColor).rgb , temp_cast_7 , vertexToFrag11_g62655);
				...
				float dotResult3851_g55655 = dot( ViewDir_Normalized3963_g55655 , NormalsWS_Derivates3972_g55655 );
				float lerpResult3993_g55655 = lerp( 1.0 , saturate( abs( dotResult3851_g55655 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g55655 = lerpResult3993_g55655;
				float vertexToFrag11_g62653 = IN.ase_texcoord10.w;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62653;
				float temp_output_41_0_g62674 = ( Fade_Glancing3853_g55655 * Fade_Camera3743_g55655 );
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				o.ase_texcoord3.xyz = vertexToFrag4224_g55655;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_4023_0_g55655 = (Mesh_Variation16_g55655*0.5 + 0.5);
				float4 temp_output_93_19_g62635 = TVE_ExtrasCoords;
				float3 vertexToFrag4224_g55655 = IN.ase_texcoord3.xyz;
				half3 ObjectData20_g62665 = vertexToFrag4224_g55655;
				half3 WorldData19_g62665 = vertexToFrag3890_g55655;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g62665 = WorldData19_g62665;
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;3023.365;858.4889;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;651;-1856,384;Inherit;False;Define Pipeline Universal;-1;;55654;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=486F6D39812D8E2ED62E7FDA72A636582BF8A273
