...
namespace TheVegetationEngine
{
    public class TVESceneDebugger : EditorWindow
    {
        ...
        {
        "Material Conversion", "Material Type", "Material Lighting", "Texture Maps", "Texture Resolution", "Global Textures", "Mesh Attributes", "Misc Debugging",
        };
        ...
        void OnGUI()
        {
            ...
            if (debugTypeIndex == 7)
            {
                ...
                StyledLegend("Leaf Mask", new Color(0.44f, 0.79f, 0.18f, 0.75f));
                StyledLegend("Bark Mask", new Color(1f, 0.21f, 0.1f, 0.75f));
            }
