...
Shader "ANGRYMESH/PBR Rocks/VS BlendTop (Legacy)"
{
	Properties
	{
		...
		[Normal][NoScaleOffset]_BaseNormalMap("Base NormalMap", 2D) = "white" {}
	...
	SubShader
	{
		...
		{
			float2 uv_BaseNormalMap315 = i.uv_texcoord;
			float3 tex2DNode315 = UnpackNormal( tex2D( _BaseNormalMap, uv_BaseNormalMap315 ) );
			float2 temp_output_195_0 = ( i.uv_texcoord * _TopUVScale );
			float2 TopUVScale197 = temp_output_195_0;
			float3 NormalMap166 = tex2DNode315;
			...
			float3 lerpResult158 = lerp( tex2DNode315 , UnpackScaleNormal( tex2D( _TopNormalMap, TopUVScale197 ), _TopNormalIntensity ) , ( TopMask168 * TopNoise225 ).rgb);
			...
			float4 lerpResult157 = lerp( ( _BaseColor * tex2DNode162 ) , ( _TopColor * tex2DNode172 ) , ( TopMask168 * TopNoise225 ));
...
/*ASEBEGIN
Version=16702
1927;29;1906;1004;5371.825;-44.34487;1.292734;True;False
Node;AmplifyShaderEditor.SamplerNode;315;-2192,512;Float;True;Property;_BaseNormalMap;Base NormalMap;4;2;[Normal];[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;166;-1712,512;Float;False;NormalMap;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;212;-1661,-1444;Float;False;AlbedoAlphaSmoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;171;-1824,1024;Float;False;168;TopMask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;265;-1824,1152;Float;False;225;TopNoise;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;139;-2688,896;Half;False;Property;_TopNormalIntensity;Top Normal Intensity;13;0;Create;True;0;0;False;0;1;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;231;-4481,-2289;Half;False;Constant;_White;White;19;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;119;-2192,768;Float;True;Property;_TopNormalMap;Top NormalMap;16;2;[Normal];[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;258;-1520,1024;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;163;-1152,-1664;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;208;-288,1024;Float;False;207;AO;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;237;-2688,-1920;Float;False;100;100;;0;// Blend Albedo;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=F1AFF1CCA83960994512F3D364C2D0510D368545